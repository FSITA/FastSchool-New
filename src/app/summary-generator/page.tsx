...
import SummaryGeneratorFormContainer from '@/components/summary-generator/SummaryGeneratorFormContainer';
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <header className="max-w-4xl mx-auto px-6 pb-8">
          <div className="flex flex-col items-center">
            <h1 className="text-4xl font-bold text-[#1A1A1A] mb-3 tracking-tight text-center">
              Generatore di Riassunti IA
            </h1>
            <p className="text-lg text-[#5A5A5A] font-normal text-center max-w-2xl">
              Crea riassunti e outline strutturati dai tuoi contenuti
            </p>
          </div>
        </header>
      )}
      ...
      <main className="max-w-4xl mx-auto px-6 pb-12">
        <SummaryGeneratorFormContainer onLoadingStateChange={setIsLoading} />
      </main>
    </div>
  );
}

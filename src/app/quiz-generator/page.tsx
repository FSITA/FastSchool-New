...
import QuizGeneratorFormContainer from '@/components/quiz-generator/QuizGeneratorFormContainer';
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <header className="max-w-4xl mx-auto px-6 pb-8">
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg text-[#5A5A5A] font-normal text-center max-w-2xl">
              Crea quiz completi con domande multiple choice in pochi secondi
            </p>
          </div>
        </header>
      )}
      ...
      <main className="max-w-4xl mx-auto px-6 pb-12">
        <QuizGeneratorFormContainer onLoadingStateChange={setIsLoading} />
      </main>
    </div>
  );
}

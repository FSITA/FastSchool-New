...
export async function POST(req: Request) {
  try {
    ...
    console.log("Request Body:", { title, outline, language, tone });
    console.log("---------------------------------------------");
    ...
    const fullPrompt = slidesTemplate
    ...
    console.log("--- Sending Prompt to Gemini API for Streaming ---");
    ...
    return new Response("Failed to generate presentation slides", {
      status: 500,
    });
  }
}

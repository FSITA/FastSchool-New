...
import { renderMindmap } from '@/lib/diagram-generator/mindmap-utils/mindmapRenderer';
  ...
  useEffect(() => {
    renderMindmap({
      ...
      onNodeClick: (word: string, evt?: MouseEvent) => {
        ...
        const definition = findDefinition(mindmapData.root, word) || 'Definizione non trovata.';

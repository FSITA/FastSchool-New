...
const DiagramGenerator = () => {
  ...
  return (
    <>
      <div className="md:hidden flex bg-white dark:bg-gray-900 border-b border-gray-200/60 dark:border-gray-700/60 px-4 py-2">
        <div className="flex w-full bg-gray-100 dark:bg-gray-800 rounded-full p-1 relative overflow-hidden">
          <div 
            className={`absolute top-1 bottom-1 w-1/2 bg-white dark:bg-gray-700 rounded-full shadow-sm transition-transform duration-300 ease-out ${
      ...
      <main className="flex h-screen w-full bg-white dark:bg-gray-900 transition-colors">

...
export function FlashcardGenerator() {
  ...
  const getTranslations = (language: string) => {
    const translations: Record<string, Record<string, string>> = {
      ...
      'french': {
        title: 'Cartes Générées par FastSchool AI',
      ...
      'portuguese': {
        title: 'Cartões Gerados por FastSchool AI',
      ...
      'russian': {
        title: 'Карточки Созданы FastSchool AI',
        date: 'Дата Создания',
        flashcard: 'Карточка',
        question: 'Вопрос',
        answer: 'Ответ',
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      if (hasNonLatin || flashcardLanguage === 'chinese' || flashcardLanguage === 'russian') {
        ...
        console.log("✅ PDF downloaded successfully with Unicode support!");
      } else {

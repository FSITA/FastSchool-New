...
import MobileMenu from "@/components/quiz/global/MobileMenu";
import HamburgerButton from "./Hamburger";
import { useState } from "react";
import { GithubIcon } from "@/components/quiz/icons";
import Button from "@/components/quiz/shared/Button";

const navlinks = [
          { name: "Home", url: "/" },
          { name: "Presentations", url: "/presentation" },
          { name: "Quizzes", url: "/quiz" },
          { name: "Flashcards", url: "/flashcards" },
          { name: "Lesson Planner", url: "/lesson-planner" },
        ];

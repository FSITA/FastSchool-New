    ...
    <FormField>
      <form onSubmit={onSubmit}>
        ...
        <header className="text-center mb-10">
          <h2 className="text-lg font-semibold mb-1">Aggiungi Appunti</h2>
          <p className="text-xs text-zinc-400">
            Incolla i tuoi appunti come testo o carica un file
          </p>
        </header>
        ...
        <button className="flex items-center justify-center w-full text-center max-w-lg mx-auto duration-200 text-sm gap-x-2 bg-gray-900 hover:bg-gray-800 text-white font-medium px-4 py-3 rounded-full">
          Avanti
        </button>
      </form>
    </FormField>

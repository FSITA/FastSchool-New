...
export function PresentationLayout({
  ...
  const { currentSlideIndex, setCurrentSlideIndex, isGeneratingPresentation } = usePresentationState();
    ...
    <ThemeBackground className="h-full w-full">
      ...
      <div className="flex h-full">
        <div className="flex h-full items-center">
          ...
          >
            <div className={cn(
              "h-max max-h-[90vh] overflow-auto scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent",
              // Disable smooth scrolling during generation to prevent scrollbar flickering
              isGeneratingPresentation && "scroll-smooth-none"
            )}>
              <SlidePreview

  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative w-full",
          !isPresenting && currentSlide?.width === "S" && "max-w-3xl mx-auto",
          !isPresenting && currentSlide?.width === "M" && "max-w-4xl mx-auto",
          !isPresenting && currentSlide?.width === "L" && "max-w-6xl mx-auto",
          !isPresenting && !currentSlide?.width && "max-w-4xl mx-auto", // Default to M width

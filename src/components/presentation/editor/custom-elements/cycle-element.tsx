  ...
  ({ element, children, className, ...props }, ref) => {
    ...
    return (
      <PlateElement
        ...
        {...props}
      >
        {/* Improved layout with better spacing and no overlap */}
        <div className="mx-auto max-w-4xl">
          {/* Central SVG wheel with proper spacing */}
          <div className="relative mx-auto mb-8 h-48 w-48 flex-shrink-0">
            <svg
          ...
          {/* Items arranged in a responsive grid below the circle */}

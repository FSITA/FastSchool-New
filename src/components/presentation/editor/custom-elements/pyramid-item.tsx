...
export const PyramidItem = ({
  ...
  return (
    ...
    >
      ...
      {/* The pyramid item layout - improved to prevent text overlap */}
      <div className="flex items-start gap-4 border-b border-gray-700 pb-4">
        {/* Shape with number - fixed width to prevent overlap */}
        <div className="flex-shrink-0">
          <div
            className="grid place-items-center text-2xl font-bold min-w-[80px]"
            style={{
              height: `${shapeHeight}px`,
              width: `${Math.max(80, shapeHeight * 0.8)}px`,
              clipPath: clipPath,
        ...
        {/* Content area with proper spacing and no negative positioning */}

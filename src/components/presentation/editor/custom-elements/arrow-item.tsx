...
export const ArrowItem = ({
  ...
  return (
    <div
      ref={previewRef}
      className={cn(
        "group/arrow-item relative mb-4 flex min-h-[80px] gap-4",
    ...
    >
      ...
      {/* Chevron icon column - fixed positioning */}
      <div className="flex w-16 flex-shrink-0 items-center justify-center">
        <svg className="h-12 w-12 fill-primary">
          <path d="M0,90L45,108L90,90L90,0L45,18L0,0Z"></path>
        </svg>
      </div>

      {/* Content column - improved spacing */}

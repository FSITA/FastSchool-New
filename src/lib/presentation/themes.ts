...
export function setThemeVariables(theme: ThemeProperties, isDark: boolean) {
  ...
  try {
    ...
    const variables = {
      ...
      "--presentation-heading-font": theme.fonts.heading,
      "--presentation-body-font": theme.fonts.body,
      "--presentation-border-radius": theme.borderRadius,
      "--presentation-transition": theme.transitions.default,
    ...
    console.warn("Error setting theme variables:", error);
  }
}
